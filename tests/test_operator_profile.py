...
def test_operator_profile_has_verified_company_identity_and_public_support_phone():
    ...
    assert OPERATOR.support_phone == "+421 917 347 009"
...
def test_public_profile_formats_ico_and_includes_verified_phone_without_inventing_tax_data():
    ...
    assert data["support_phone"] == "+421 917 347 009"
